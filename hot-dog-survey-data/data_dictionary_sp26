...
| How strongly do you feel about your previous answer? | Strength of opinion about whether a hot dog is a sandwich | Ordinal categorical | 1 (Not at all) – 5 (Very strong) | Ordered scale |
| How frequently do you eat hot dogs? | How often the respondent eats hot dogs | Ordinal categorical | Never, Rarely, Occasionally, Frequently | Ordered frequency scale |
